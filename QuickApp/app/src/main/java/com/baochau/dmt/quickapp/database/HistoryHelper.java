...
public class HistoryHelper extends QuestionHelper {
    ...
    public void addNewHistory(@Nullable String name,@NonNull String result, @NonNull String time) {
    ...
    public ArrayList<ItemHistory> getListHistory() {
        ...
        while (cursor.moveToNext()) {
            ItemHistory itemHistory = new ItemHistory(cursor.getInt(0), cursor.getString(1), cursor.getString(2), cursor.getString(3));
